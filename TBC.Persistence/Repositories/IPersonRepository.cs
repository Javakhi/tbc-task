...
namespace TBC.Persistence.Repositories
{
    public interface IPersonRepository
    {
        ...
        Task<List<PersonEntity>> GetByPersonByIdAsync(int userId, CancellationToken cancellationToken = default);
        Task<PersonEntity> UpdatePersonInformation(int id, PersonEntity person, CancellationToken cancellationToken = default);

        Task<PersonEntity> DeletePersonByIdAsync(int id, PersonEntity person, CancellationToken cancellationToken = default);
    }
}
